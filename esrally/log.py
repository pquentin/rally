...
def configure_time_formatter(*args, **kwargs):
    """
...
def migrate_logging_configuration():
    """Upgrade logging configuration to newer versions of Rally
